...
function worksheetXml(model,hasChart){
  ...
  const sheetRows=[
    ...
    rowXml(headerRow,headers.map((header,index)=>textCell(`${columnName(index)}${headerRow}`,header,3)),34)
  ];
